...
class AirtelPage extends StatefulWidget {
  ...
  _AirtelPageState createState() => _AirtelPageState();
}
          ...
          SliverPadding(
            ...
            sliver: SliverGrid.count(
              ...
              children: [
                ...
                _buildGridItem(context, 'Make Payment', Icons.payment, const MakePaymentsPage()),
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, size: 30.0, color: Colors.red),
  ...
  void showConfirmationDialog(String itemName, BuildContext context) {
    ...
    if (itemName == 'From Agent') {
      fields = [
        ...
        TextField(
          controller: pinController,
          obscureText: true, //hide PIN character
          decoration: const InputDecoration(
            labelText: 'PIN',
          ),
        ),
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                //access data from controllers and log it
...
//define page for making payments
class MakePaymentsPage extends StatelessWidget {
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            title: Text(itemName),
            onTap: () {
                //navigation to the selected index
              showConfirmationDialog(itemName, context);
            },
          );
        },
  ...
  void showConfirmationDialog(String itemName, BuildContext context) {
    ...
    final TextEditingController pinController = TextEditingController();
     ...
     //using if else condition to specify dialog fields
    List<Widget> fields;
    if (itemName == 'Paybill') {
      fields = [
        TextField(
